...
def train_resample(train_data_path, samples_class=10000, seed=42):
    ...
    train_data_minority_S = train_data[train_data.label==1]
    train_data_minority_V = train_data[train_data.label==2]
    train_data_minority_F = train_data[train_data.label==3]
    train_data_minority_Q = train_data[train_data.label==4]
    ...
    print('Train data resampling completed.')
    return